...
export function defaultOptions() {
  ...
  return {
    ...
    ...(config.httpProxy
      ? {
          agent: {
            https: new HttpsProxyAgent({ proxy: config.httpProxy })
          }
        }
      : {}),
 ...
 * @returns {Promise<object>} The result of the request; whether it succeeded and the response or error returned
 */
export async function get(url, additionalOptions = {}) {
 ...
 * @returns {Promise<object>} The result of the request; whether it succeeded and the response or error returned
 */
export async function patch(url, additionalOptions = {}) {
 ...
 * @returns {Promise<object>} The result of the request; whether it succeeded and the response or error returned
 */
export async function post(url, additionalOptions = {}) {
